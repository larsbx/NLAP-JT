...
This directory contains reproducible, non-authoritative Julia implementations for BigInt/rational arithmetic, certificate generation, and differential replay against the Mojo checker.
